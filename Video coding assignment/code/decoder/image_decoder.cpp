...
std::vector<DataType> ImageDecoder::createImage(std::vector<Block>& blocks, int width, int height) {
...
std::vector<Block> ImageDecoder::decodeBlocks(std::vector<Block> blocks, const std::vector<float>& quant_mat){
...
Block ImageDecoder::dequantizize_block(Block block, const std::vector<float>& quant_mat){
