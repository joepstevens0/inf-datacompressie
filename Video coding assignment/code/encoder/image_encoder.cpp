...
std::vector<Block> ImageEncoder::createBlocks(const std::vector<DataType>& input_img, int width, int height) {
...
std::vector<Block> ImageEncoder::dctBlocks(std::vector<Block>& blocks){
...
std::vector<Block> ImageEncoder::quantBlocks(std::vector<Block>& dct_blocks, const std::vector<float>& quant_mat){
...
Block ImageEncoder::quantizize_block(Block block, const std::vector<float>& quant_mat){
